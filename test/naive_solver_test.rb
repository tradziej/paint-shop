...
class NaiveSolverTest < Minitest::Test
  def test_solve_simple_example
    ...
    solver = PaintShop::NaiveSolver.new(colors_number: 5, customers: customers)
  ...
  def test_solve_no_solution
    ...
    solver = PaintShop::NaiveSolver.new(colors_number: 1, customers: customers)
  ...
  def test_solve_another_simple_example
    ...
    solver = PaintShop::NaiveSolver.new(colors_number: 2, customers: customers)
  ...
  def test_solve_for_single_customer
    [PaintShop::Customer.parse('1 M'), PaintShop::Customer.parse('1 G')].each do |customer|
      solver = PaintShop::NaiveSolver.new(colors_number: 1, customers: [customer])
